...
export const PERSONALITY_RESPONSES: Record<string, Record<string, string>> = {
  accountant: {
    ...
    neutral: "Yes, we handle self-assessment for sole traders. Our standard fee starts from £150+VAT. Could you let me know roughly what your turnover was for the year and whether you have your records ready?",
  ...
  solicitor: {
    ...
    neutral: "Yes, we handle residential conveyancing. To prepare a fee estimate, I'll need the property address and purchase price. Are you using a mortgage or cash purchase?",
  ...
  plumber: {
    ...
    neutral: "Yes, we do emergency callouts. For a leaking tap, we can typically be with you within 2 hours. Could you share your postcode and best contact number?",
  ...
  electrician: {
    ...
    neutral: "Yes, we carry out EICR inspections. For a 3-bed rental, pricing starts at £150. We issue the certificate within 24 hours. What date works for you?",
  ...
  builder: {
    ...
    neutral: "Yes, we do loft conversions. We'd need to do a site visit to provide an accurate quote — there's no charge for that. What's your availability this week or next?",
  ...
  landscaper: {
    ...
    neutral: "Yes, we offer free site visits and quotes for garden redesigns. Could you share your postcode so I can check availability and arrange a convenient time?",
  ...
  roofer: {
    ...
    neutral: "Yes, we can help. We can arrange an inspection — usually next working day. Could you share your address and a contact number?",
  ...
  gardener: {
    ...
    neutral: "Yes, we offer monthly garden maintenance contracts. We'd need to visit the property to assess the work involved and provide a quote. What's your postcode?",
  ...
  fencing: {
    ...
    neutral: "For close board fencing, pricing depends on ground conditions and access. We'd need a site visit to quote accurately — it's free and takes around 20 minutes. What's your postcode?",
  ...
  paving: {
    ...
    neutral: "Yes, we can arrange a site visit. It's free and allows us to measure the area, check the base condition, and show you style options. What's your availability?",
  ...
  decking: {
    ...
    neutral: "Yes, we install composite decking. We carry several brands including Trex and Millboard. A site visit with samples is the best next step — no charge. When are you available?",
  ...
  "tree-surgeon": {
    ...
    neutral: "Yes, we handle tree reduction work. We're NPTC qualified and fully insured. I can arrange a site inspection to assess the oak and provide a quote. What's your postcode?",
  ...
  cleaner: {
    ...
    neutral: "Yes, we offer end-of-tenancy deep cleans. For a 3-bed house it typically takes 4-6 hours. Could you confirm the date you need it done and your postcode?",
  ...
  dental: {
    ...
    neutral: "Yes, we have emergency appointments available. Please give me your name and I'll check our earliest slot today. Are you an existing patient with us?",
  ...
  "estate-agent": {
    ...
    neutral: "The market for 3-bed semis is performing well with good buyer demand. I'd recommend a free valuation to give you a realistic price for your specific property. What's your availability?",
  ...
  recruitment: {
    ...
    neutral: "We can help with that. We have qualified electricians on our books in the Leeds area. To shortlist candidates, I'll need: CSCS card requirements, start date, and the day rate or salary range.",
  ...
  "hair-salon": {
    ...
    neutral: "Yes, we offer balayage. We recommend a free consultation first to assess your hair and agree on the technique and tones. When would suit you?",
  ...
  "dog-groomer": {
    ...
    neutral: "Yes, we have availability this week. For a matted cockapoo, allow around 1.5-2 hours. What days work for you, and what's his name?",
...
export function getPreviewConversation(industry: string, personality: string): { question: string; answer: string } {
  ...
  const answer = responses[personality] ?? responses['neutral']
